%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                       %
% 000_thesis.tex: A template file for usage with ustthesis.cls         %
%                                                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{xspace}         % smart spacing after custom text macros
\usepackage{epsfig}
\usepackage{amssymb}
...
\title{Your Thesis Title}  % Title of the thesis.
...
\chapter{Scientific Background and Literature Review}
\label{chp_review}
\input{02_scientific_background_literature_review.tex}
\newpage
